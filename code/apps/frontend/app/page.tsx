            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl">
                  Book your next <span className="text-primary">glow up</span> today.
                </h1>
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <Button size="lg" className="h-12 px-8 text-lg rounded-full" onClick={() => router.push('/book')}>
                    Book an Appointment
                  </Button>
                  <Button variant="outline" size="lg" className="h-12 px-8 text-lg rounded-full" onClick={() => router.push('/auth/register')}>
                    List your Business
                  </Button>
                </div>
              </div>
