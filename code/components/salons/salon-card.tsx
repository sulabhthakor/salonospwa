...
export function SalonCard({ id, name, businessName, serviceCount }: SalonCardProps) {
    return (
        <Link href={`/salons/${id}`} className="block h-full">
            <Card className="overflow-hidden hover:shadow-lg transition-all duration-300 group border-border/40 h-full flex flex-col">
                ...
                <CardFooter className="p-4 pt-2 border-t bg-muted/10 mt-auto">
                    <Button asChild className="w-full pointer-events-none" variant="secondary">
